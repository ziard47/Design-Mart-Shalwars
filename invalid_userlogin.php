			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="customerAccount.php" class="flex-c-m trans-04 p-lr-25">
							My Account
						</a>
			...
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						...
						<a href="customerAccount.php" class="flex-c-m p-lr-10 trans-04">
							My Account
						</a>

						<a href="customerlogout.php" class="flex-c-m p-lr-10 trans-04">
							LOGOUT
						</a>
					</div>
				</li>
        ...
        <div class="col-lg-5 col-md-5 offset-lg-4 offset-md-4">
          ...
          <form class="" action="Userlogin_2.php" method="post">
            ...
            <div class="form-row align-item-left">
               ...
               <div class="form-group col-lg-12 col-md-12">
                  ...
                  <div class="input-group mx-1 mb-2 ">
                    ...
                    <input type="email" class="form-control "
                     id="email" name="email" placeholder="use your email address">
                </div>
             ...
             <div class="form-group col-lg-12 col-md-12">
               <label class="label mx-1" for="signup"><a href="signup_1.php">Dont have an Account? Signup.</a></label>
             </div>
	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				Copyright &copy; 2021 | Designed By Mohomed Ziard
