...
<body class="animsition">
			...
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						...
						<a href="dashboard.php" class="flex-c-m p-lr-10 trans-04">
							LOGOUT
						</a>
					</div>
				</li>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-5 offset-lg-4 offset-md-4">
          <h2 class="text-center text-success">User details</h2>
          <hr>

          <form class="" action="EditCustomer_1.php" method="post">

            <div class="form-row align-item-left">

              <?php
    								$sql = "select * from customer_log where email";
    								// print_r($sql);
               ...
               <div class="form-group col-lg-12 col-md-12">
                  ...
                  <label class="label mx-1" for="name"><?php echo $row['cus_name']; ?></label>
              ...
              <div class="form-group col-lg-12 col-md-12">
                 ...
                 <label class="label mx-1" for="name"><?php echo $row['address']; ?></label>
